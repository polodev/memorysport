const fatepurHome = [
  ...
  "door of east wall",
  "door of south wall to enter into didi's room",
  "didi's room east wall",
  "didi's room east wall window",
  "didis room south wall",
  "didis room south wall window",
  "cassette player",
  "wall alna to store horinarayan",
...
const palashpurBasudev = [
  ...
  "oven area",
  "south toilet",
  "room adjacent toilet",
  "room adjacent our main room",
  "entrace door of our main door",
